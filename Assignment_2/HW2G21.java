...
//        ArrayList<Tuple2<Vector,Integer>> sample = new ArrayList<>();`
        for(int i=0;i<nCluster;i++)
...
//            sample.add(clustSamp.get(i));        //LIST -> ARRAYLIST
        ...
        System.out.println("Vedi dashboard di spark at: http://192.168.1.21:4040/jobs/");
